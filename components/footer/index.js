...
const Footer = () => {
  return (
    <footer className="mt-10 py-8 text-gray-500">
      <div className="wrapper px-[15px] border-t border-header_bg py-4 mx-auto flex flex-col sm:flex-row justify-between">
