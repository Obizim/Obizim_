  ...
  return (
    <main className={`pt-20 text-lg max-w-screen-md mx-auto px-5 ${jost.className}`}>
     <section className="space-y-4">
        ...
        <p className="text-gray-300 w-full max-w-2xl"> I'm Zimuzo Obi, a goal-oriented developer, bringing strong dedication to collaboration and a solutions-oriented approach to problem-solving.
        Higly attentive to details with strong work ethic as well as adept at implementing new technologies and techniques 
        </p>
        <div className="text-gray-300 w-full max-w-2xl">I have experience with the following technologies and languages: 
        ...
        <div className="my-4">
          {works.map(data => (
            ...
            <div className="flex items-end space-x-2">
              <p className="self-start text-gray-300">0{data.id}.</p>
